...
const Footer = () => {
    return (
        <footer className="text-gray-600 mt-12 fixed bottom-0 left-0 w-full">
            <div className="container mx-auto flex items-center flex-col sm:flex-row py-8">
                <a
                    ...
                    <span className="ml-3 text-md text-cyan-100">Next Blog</span>
                </a>
                <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                    Blog site for everybody
                    <a
                        href="https://twitter.com/404Nikhil"
